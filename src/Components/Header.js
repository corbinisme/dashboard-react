...
function Header(props) {
    ...
    return(
        <header className="bg-light">
            ...
            <nav className="navbar navbar-expand-lg navbar-shrink navbar-light fixed-top" id="mainNav">
